...
static void server_stats(ADD_STAT add_stats, conn *c) {
	...
	printf("sizeof(IN) = %lu\n", sizeof(IN));
	printf("sizeof(PLN) = %lu\n", sizeof(PLN));
	printf("sizeof(LN) = %lu\n", sizeof(LN));
	printf("Total space = %lu byte\n",
			(IN_cnt + LN_cnt) * sizeof(LN));
	printf("Space efficiency = %lu\n", 
			((IN_cnt + LN_cnt) * sizeof(LN)) / INPUT_NUM);
	printf("IN count = %lu\n", IN_cnt);
    printf("LN count = %lu\n", LN_cnt);
    printf("clflush count = %lu\n", clflush_count);
	printf("mfence count = %lu\n", mfence_count);
    printf("reconstruct count = %lu\n\n", reconstruct_count);
