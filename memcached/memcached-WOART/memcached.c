...
extern unsigned long node4_count;
extern unsigned long node16_count;
extern unsigned long node48_count;
extern unsigned long node256_count;
extern unsigned long leaf_count;
extern unsigned long mfence_count;
extern unsigned long clflush_count;
extern unsigned long path_comp_count;
extern unsigned long sum_depth;
...
static void server_stats(ADD_STAT add_stats, conn *c) {
	...
	printf("Space efficiency = %lu\n", 
			(node4_count * sizeof(art_node4) + node16_count * sizeof(art_node16)
			 + node48_count * sizeof(art_node48) + node256_count * sizeof(art_node256)) / INPUT_NUM);
	printf("node4 count = %lu\n", node4_count);
	printf("node16 count = %lu\n", node16_count);
	printf("node48 count = %lu\n", node48_count);
	printf("node256 count = %lu\n", node256_count);
...
int main (int argc, char **argv) {
	printf("Hello Kwang Hyun! This is radix\n");
    int c;
	...
	printf("before memcached_thread_init\n");
