...
int main(void)
{
	...
	int i;
	char *dummy;
	unsigned long *keys, *keys1, *keys2, *keys3, *keys4, *new_value;
	...
	keys1 = malloc(sizeof(unsigned long) * 4);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("32B malloc time = %lu\n", elapsed_time);

	clock_gettime(CLOCK_MONOTONIC, &t1);
	keys2 = pmalloc(sizeof(unsigned long) * 4);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("32B pmalloc time = %lu\n", elapsed_time);

	clock_gettime(CLOCK_MONOTONIC, &t1);
	memset(keys1, 1, sizeof(unsigned long) * 4);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("32B malloc memset time = %lu\n", elapsed_time);

	clock_gettime(CLOCK_MONOTONIC, &t1);
	memset(keys2, 1, sizeof(unsigned long) * 4);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("32B pmalloc memset time = %lu\n", elapsed_time);

	clock_gettime(CLOCK_MONOTONIC, &t1);
	keys3 = malloc(sizeof(unsigned long) * 256);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("2KB malloc time = %lu\n", elapsed_time);

	clock_gettime(CLOCK_MONOTONIC, &t1);
	keys4 = pmalloc(sizeof(unsigned long) * 256);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("2KB pmalloc time = %lu\n", elapsed_time);

	clock_gettime(CLOCK_MONOTONIC, &t1);
	memset(keys3, 1, sizeof(unsigned long) * 256);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("2KB malloc memset time = %lu\n", elapsed_time);

	clock_gettime(CLOCK_MONOTONIC, &t1);
	memset(keys4, 1, sizeof(unsigned long) * 256);
	clock_gettime(CLOCK_MONOTONIC, &t2);
	elapsed_time = (t2.tv_sec - t1.tv_sec) * 1000000000;
	elapsed_time += (t2.tv_nsec - t1.tv_nsec);
	printf("2KB pmalloc memset time = %lu\n", elapsed_time);
